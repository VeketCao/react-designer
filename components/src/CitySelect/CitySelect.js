 ...
 */
window.CitySelect = React.createClass({
    data:[
           {
               "p": "北京",
               "c": [
    ...
    getProvince:function () {
        return (
            <select ref="p" style={{height: '28px',color:'#5a5955',fontWeight:'inherit'}} onChange={function (e) {
                var value = e.target?e.target.value:"";
                var p_data = _.findWhere(this.data,{p:value});
                this.setState({
                    p:value,
                    n:"",
                    s:"",
                ...
                this.state.currentP = "";
                this.state.currentN = "";
                if(this.refs.n) this.refs.n.value = "";
                if(this.refs.s) this.refs.s.value = "";

                this.valueOnchange(value);
            }.bind(this)}>
                <option value="">请选择</option>
                {
                    _.map(this.data,function (item) {
                        return <option value={item.p}>{item.p}</option>
                    })
                }
            </select>
        )
    ...
    getCity:function(){
        return (
            <select ref="n" style={{height: '28px',color:'#5a5955',fontWeight:'inherit'}} onChange={function (e) {
                var value = e.target?e.target.value:"";
                var n_data = _.findWhere(this.state.currentP.c,{n:value});
                this.setState({
                    n:value,
                    s:"",
                    currentN:n_data
                ...
                this.state.currentN = "";
                if(this.refs.s) this.refs.s.value = "";
                this.valueOnchange(this.state.p,value,this.state.s);
            }.bind(this)}>
                <option value="">请选择</option>
                {
                    _.map(this.state.currentP.c||[],function (item) {
                        return <option value={item.n}>{item.n}</option>
                    })
                }
            </select>
        )
    ...
    getTown:function(){
        return (
            <select ref="s" style={{height: '28px',color:'#5a5955',fontWeight:'inherit'}} onChange={function (e) {
                var value = e.target?e.target.value:"";
                this.setState({
                    s:value
                });
                this.valueOnchange(this.state.p,this.state.n,value);
            }.bind(this)}>
                <option value="">请选择</option>
                {
                    _.map(this.state.currentN.a,function (item) {
                        return <option value={item.s}>{item.s}</option>
                    })
                }
            </select>
        )
